namespace FluentValidation.Tests
{
	...
	using System;
	[TestFixture]
	public class NestedConditionTests
	{
		private class NestedConditionValidator : AbstractValidator<Person>
		{
		...
		private class NestedConditionWithScopedUnlessValidator : AbstractValidator<Person>
		{
			public NestedConditionWithScopedUnlessValidator()
			{
		...
		{
			var validator = new NestedConditionValidator();
		...
		{
			var validator = new NestedConditionWithScopedUnlessValidator();
			var person = new Person()
			{
				Id       = 4						// triggers the shared When predicate
			};
